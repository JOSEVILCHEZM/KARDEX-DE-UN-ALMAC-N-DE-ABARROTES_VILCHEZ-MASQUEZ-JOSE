            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped table-responsive-sm">
                ...
                <tr>
                  ...
                  <td>
                      <a href="" title="Editar" data-toggle="modal" data-target="#modal-default" onclick="javascript:showFunctionModal(
                         '<?php echo $r->id; ?>',
                         '<?php echo $r->nombre; ?>',
                         '<?php echo $r->estado?>',
                         'Modificar' );">
                      ...
                      <a  title="Eliminar"  onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=Perfil&a=Eliminar&id=<?php echo $r->id; ?>"><i class="fas fa-trash-alt"></i></a>
                  </td>
                </tr>

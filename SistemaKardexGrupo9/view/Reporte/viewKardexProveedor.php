...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Kardex Proveedor</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="?c=Inicio&a=Index">Inicio</a></li>
            <li class="breadcrumb-item ">Reportes</li>
            <li class="breadcrumb-item active">Kardex del Proveedor</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group">
                  <label for="id_cliente_fk">Proveedor</label>
                  <select class="form-control" id="id_cliente_fk" name="id_cliente_fk" required style="width: 100%;">

                    <option value="-1">Seleccionar</option>

                    <?php $i = 1;
                    foreach ($this->oProveedor->Listar() as $r) : ?>
                      <option value="<?php echo $r->id; ?>"><?php echo $r->razonSocial; ?> <?php echo "-".$r->direccion; ?></option>
                    <?php endforeach; ?>
